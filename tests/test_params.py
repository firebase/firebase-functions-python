...
class TestBoolParams:
    ...
    def test_bool_param_empty_default(self):
        ...
        assert params.BoolParam("BOOL_DEFAULT_TEST").value is False, "Failure, params returned True"

    def test_bool_param_default(self):
        """Testing if bool params defaults to provided default value."""
        assert params.BoolParam("BOOL_DEFAULT_TEST_FALSE", default=False).value is False, (
            "Failure, params returned True"
        )
        assert params.BoolParam("BOOL_DEFAULT_TEST_TRUE", default=True).value is True, (
            "Failure, params returned False"
        )

    def test_bool_param_equality(self):
        """Test bool equality."""
        assert params.BoolParam("BOOL_TEST1", default=False).equals(False).value is True, (
            "Failure, equality check returned False"
        )
        assert params.BoolParam("BOOL_TEST2", default=True).equals(False).value is False, (
            "Failure, equality check returned False"
        )
...
class TestFloatParams:
    ...
    def test_float_param_equality(self):
        """Test float equality."""
        assert params._FloatParam("FLOAT_TEST1", default=123.456).equals(123.456).value is True, (
            "Failure, equality check returned False"
        )
        assert params._FloatParam("FLOAT_TEST2", default=456.789).equals(123.456).value is False, (
            "Failure, equality check returned False"
        )
...
class TestIntParams:
    ...
    def test_int_param_value(self):
        ...
        assert params.IntParam("INT_VALUE_TEST").value == 123, "Failure, params value != 123"
    ...
    def test_int_param_equality(self):
        """Test int equality."""
        assert params.IntParam("INT_TEST1", default=123).equals(123).value is True, (
            "Failure, equality check returned False"
        )
        assert params.IntParam("INT_TEST2", default=456).equals(123).value is False, (
            "Failure, equality check returned False"
        )
...
class TestStringParams:
    ...
    def test_string_param_default(self):
        ...
        assert (
            params.StringParam("STRING_DEFAULT_TEST2", default="string_override_default").value
            == "string_override_default"
        ), 'Failure, params default value != "string_override_default"'

    def test_string_param_equality(self):
        """Test string equality."""
        assert params.StringParam("STRING_TEST1", default="123").equals("123").value is True, (
            "Failure, equality check returned False"
        )
        assert params.StringParam("STRING_TEST2", default="456").equals("123").value is False, (
            "Failure, equality check returned False"
        )
...
class TestListParams:
    ...
    def test_list_param_default(self):
        ...
        assert params.ListParam("LIST_DEFAULT_TEST2", default=["1", "2"]).value == ["1", "2"], (
            'Failure, params default value != ["1", "2"]'
        )

    def test_list_param_equality(self):
        """Test list equality."""
        assert params.ListParam("LIST_TEST1", default=["123"]).equals(["123"]).value is True, (
            "Failure, equality check returned False"
        )
        assert params.ListParam("LIST_TEST2", default=["456"]).equals(["123"]).value is False, (
            "Failure, equality check returned False"
        )
...
class TestParamsManifest:
    ...
    def test_params_stored(self):
        ...
        assert param.value == "TEST_STORING_VALUE", 'Failure, params value != "TEST_STORING_VALUE"'
        # pylint: disable=protected-access
        assert params._params["TEST_STORING"] == param, "Failure, param was not stored"
